    ...
    if (
      ...
      return (
        <div className="space-y-3">
          ...
          <button type="button" onClick={addExpenseRow} className={ghostBtn}>
            Add expense row
          </button>
        </div>
      );
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 max-w-xl text-sm leading-7 text-[#9b927f] md:text-base">
                Hardcoded profile data is loaded directly on this page. Start the AI budgeting flow for one-question-at-a-time financial guidance.
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <button onClick={resetSession} className={ghostBtn}>
                Reset session
              </button>
            </div>
          </div>
              ...
              <div className={`${sectionCard} p-6 md:p-8`}>
                <div className="rounded-[1.4rem] border border-dashed border-amber-300/15 bg-[#131313]/90 p-6">
                  ...
                  <p className="mt-3 text-sm leading-7 text-[#9b927f]">
                    Start the AI budgeting session to begin a guided one-question-at-a-time financial interview based on the hardcoded user data shown on this page.
                  </p>
                </div>
              </div>
            )}
