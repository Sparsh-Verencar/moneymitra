...
export const topics: Topic[] = [
        ...
        concepts: [
          {
            ...
            content:
              'A financial goal is something you want to achieve with money in the future.',
            keyPoints: [
              'Goals give purpose',
              'Use SMART framework',
              'Review quarterly',
          ...
          },
          {
            ...
            content:
              'Income assessment means calculating how much money you actually have to spend and save each month.',
            incomeCalculator: {
          ...
          },
          {
            ...
            content:
              "Expense estimation means figuring out how much money you'll need to spend each month.",
        ...
        concepts: [
          {
            ...
            content:
              "Saving is like keeping seeds in a box; they are safe, but they will never become trees. Investing is like planting those seeds in fertile soil. It involves a bit of patience and a tiny bit of risk, but it is the only way to get a harvest.\n\nMost Indian families are great at saving (putting money in a piggy bank or a zero-interest savings account), but to beat rising prices, you must move from being a 'saver' to an 'investor'.",
            keyPoints: [
            ...
            realWorldExample:
              'Ramesh saves ₹10,000 in a box. After 5 years, he still has ₹10,000. Suresh invests ₹10,000 in a safe government scheme. After 5 years, Suresh has ₹14,000. Suresh can now buy more than Ramesh can.',
          },
          {
            id: 2,
            title: 'Inflation: The Silent Money Eater',
            content:
              'Inflation is the reason why a movie ticket that cost ₹20 thirty years ago now costs ₹250. It is the steady increase in the price of goods and services. If your money is not growing at a rate higher than inflation (usually 6-7% in India), you are actually becoming poorer every day, even if your bank balance stays the same.',
            keyPoints: [
            ...
            realWorldExample:
              "In 1990, ₹100 could buy a full week of groceries. Today, ₹100 might only buy a liter of milk and some bread. If you hid ₹100 in 1990 and took it out today, it has 'shrunk' in value.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    overview:
      "Taxes are the contribution we make to the country's development, but the government also provides many 'legal paths' to reduce this burden if you save for your future. Tax planning is simply the art of arranging your money so that you pay the right amount of tax while maximizing your family's savings.",
    importance:
      "Many people in India pay more tax than they need to simply because they don't understand the rules. By learning a few simple sections of the tax law, you can save thousands of rupees every year—money that could go toward your children's education or your own retirement.",
    subtopics: [
      {
        id: 1,
        ...
        concepts: [
          {
            ...
            content:
              "In India, tax isn't a flat rate for everyone. It works like a 'stepped ladder'. You don't pay any tax on your initial earnings (up to a certain limit). As you climb higher and earn more, only the 'extra' money is taxed at a higher rate. This ensures that those who earn less are protected.",
            keyPoints: [
            ...
            realWorldExample:
              'Imagine a ladder. The first few steps are free. Only when you reach the 7th or 8th step does the government ask for a small percentage of that specific step. You never pay a high tax on your very first rupee earned.',
          },
          {
            id: 2,
            title: 'Direct vs. Indirect Tax',
            content:
              "There are two ways the government collects money. 'Direct Tax' is what you pay on your salary or business profit (Income Tax). 'Indirect Tax' is what you pay when you buy a biscuit, a car, or a phone (GST). While you can't avoid GST, you can legally reduce your Income Tax through smart savings.",
            keyPoints: [
        ...
        concepts: [
          {
            ...
            content:
              "This is the most famous rule in Indian tax law. It allows you to reduce your 'taxable income' by up to ₹1.5 Lakh every year. If you earn ₹8 Lakh and invest ₹1.5 Lakh in 80C options, the government will calculate your tax as if you only earned ₹6.5 Lakh. It is a massive discount for being a disciplined saver.",
            keyPoints: [
        ...
        concepts: [
          {
            ...
            content:
              "The NPS is a modern way to save for retirement. It's like a 'voluntary pension'. You put in money during your working years, and the government gives you an *additional* tax benefit of ₹50,000 (above the 80C limit). When you retire at 60, you get a large lumpsum and a regular monthly pension.",
            keyPoints: [
          ...
          },
          {
            ...
            content:
              "If you work in a company, a small portion of your salary is automatically cut and put into your EPF account. Your employer also contributes an equal amount. This is your 'forced' savings. It earns a good interest rate and is completely tax-free when you withdraw it after retirement.",
            keyPoints: [
        ...
        concepts: [
          {
            ...
            content:
              "Paying for health insurance for yourself, your spouse, and your children saves you tax up to ₹25,000. If you also pay for your elderly parents' health insurance, you can save an *additional* ₹50,000. This is the government's way of rewarding you for taking care of your family's health.",
            keyPoints: [
          ...
          },
          {
            ...
            content:
              "Buying a home is a dream for most Indians. To help, the government lets you deduct the 'Interest' you pay on your home loan (up to ₹2 Lakh) and the 'Principal' amount you repay (under the 80C limit). This effectively makes your home loan much cheaper than it looks.",
            keyPoints: [
        ...
        concepts: [
          {
            ...
            content:
              "Filing your ITR is simply a 'Yearly Report Card' you send to the government. It shows how much you earned and how much tax you already paid (TDS). Even if your income is below the taxable limit, filing your ITR is very helpful for getting bank loans or visa applications in the future.",
            keyPoints: [
  ...
  },
  {
    ...
    overview:
      "Insurance is like an umbrella. You don't buy it because you want it to rain; you buy it so that if it does rain, you and your family stay dry. It is a way to transfer your 'financial risk' to a big company so that a single accident or illness doesn't destroy your life's savings.",
    importance:
      'In India, many families are just one medical bill away from poverty. Insurance acts as a safety net. It ensures that even in your absence, your children can finish school, your spouse can live with dignity, and your elderly parents receive the best medical care.',
    subtopics: [
      {
        id: 1,
        ...
        concepts: [
          {
            ...
            realWorldExample:
              'A 30-year-old can get ₹1 Crore cover for just ₹800-₹1000 a month with Term Insurance. An Endowment plan for the same cover might cost ₹50,000+ a month!',
          },
          {
            id: 2,
            title: 'How Much Cover is Enough?',
            content:
              "A simple thumb rule in India is the '10X Rule'. Your life insurance cover (Sum Assured) should be at least 10 times your annual salary. This ensures that if the money is put in a bank, the interest alone can replace your monthly salary for your family.",
            keyPoints: [
        ...
        concepts: [
          {
            ...
            content:
              "In India, 'Third-Party' motor insurance is a legal requirement. It only pays for damage you cause to *others* (their car or their injury). It does NOT pay for your car's repair. \n\n'Comprehensive Insurance' covers everything: theft, fire, damage to your car, and third-party costs. It is highly recommended for any vehicle less than 10 years old.",
            keyPoints: [
          ...
          },
          {
            ...
            content:
              'This is a small but powerful add-on. If the owner-driver meets with an accident that leads to disability or death, the company pays a fixed amount (usually ₹15 Lakh). In 2026, the government has made this a standard part of vehicle ownership unless you already have a separate high-value accident policy.',
            keyPoints: [
        ...
        concepts: [
          {
            ...
            content:
              "Never let an insurance agent fill your form and just sign at the bottom. If they make a mistake (like saying you don't have BP when you do), the company can legally refuse to pay your claim later. Take 20 minutes to read and fill it yourself.",
            keyPoints: [
